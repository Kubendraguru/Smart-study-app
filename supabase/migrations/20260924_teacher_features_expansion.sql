...
-- =========================================================
-- SMART STUDY: TEACHER FEATURES & ASSIGNMENTS (FIXED)
-- =========================================================

-- 1. Helper functions
-- Fixed search_path and schema-qualified references.
...
-- 4. YouTube video and playlist fields
...
-- 9. Remove policies from previous versions of this migration
...
-- 10. SELECT policy
-- Teachers: any authenticated teacher can view assignments.
-- Students: current semester subjects or enrolled arrear subjects.
...
-- 11. INSERT policy
-- Teacher must own the assignment and be a verified teacher.
...
-- 12. UPDATE policy
-- Only the creating teacher can update the assignment.
...
-- 13. DELETE policy
-- Only the creating teacher can delete the assignment.
